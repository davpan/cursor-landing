...
const response: Block[] = [
  {
    kind: "paragraph",
    inlines: [
      { kind: "text", text: "Your Name is the " },
      { kind: "strong", text: "Your Title" },
      { kind: "text", text: ", based in Your City." },
    ],
  },
  { kind: "image", src: "/headshot.png", alt: "Your Name" },
  {
    kind: "paragraph",
    inlines: [
      {
        kind: "text",
        text: "A short bio goes here. Add a sentence or two about what you do and where you've worked.",
      },
    ],
  },
  {
    kind: "paragraph",
    inlines: [{ kind: "text", text: "You can find them here:" }],
  },
  {
    kind: "listItem",
    inlines: [
      { kind: "link", text: "x.com/yourhandle", href: "https://x.com/yourhandle" },
    ],
  },
  {
    kind: "listItem",
      ...
      <div className="flex max-h-full w-full max-w-[560px] flex-col overflow-hidden rounded-xl border border-[#2b2b2b] bg-[#161616] shadow-[0_24px_80px_rgba(0,0,0,0.6)]">
        ...
        <div className="min-h-0 overflow-y-auto overscroll-contain px-4 py-3 text-sm leading-relaxed text-[#c9c9c9] sm:py-4">
          ...
          <div className="sr-only">
            Your Name is the Your Title, based in Your City. A short bio goes
            here. Add a sentence or two about what you do and where you&apos;ve
            worked. Find them at{" "}
            <a href="https://x.com/yourhandle">x.com/yourhandle</a> and{" "}
